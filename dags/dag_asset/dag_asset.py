...
with DAG(
    ...
    t_upload_topdesk = PythonOperator(
        task_id="upload_assets_to_topdesk",
        python_callable=task_upload_assets_to_topdesk,
    )

    t_create_tables >> t_departments
    t_departments >> [t_users, t_delta_ean]
    t_users >> t_computers >> t_atea >> t_device_license
    [t_delta_ean, t_device_license] >> t_upload_topdesk
