...
def process_bi_user_mail() -> None:
    ...
    with db_manager.get_session() as db_session:
        ...
        logger.info(f"Processing {len(records)} records from the Excel file.")
        ...
        for record in records:
            ...
            if user_existing and user_existing.email_sent:
                logger.info(f"Skipping user as email already sent: {record['email_adresse']}")
                continue
            ...
            if user_existing is None:
                user_data = {
                    ...
                    "user_group": record.get("brugergruppe_navn"),
                    "email_sent": False,
            ...
            logger.info(f"Email marked as sent for user: {record['email_adresse']}")
