...
from dag_novax_district_control_followup.check_and_update_district_followup import check_and_update_district_followup_task
...
with DAG(
    ...
    task = PythonOperator(
        ...
        python_callable=check_and_update_district_followup_task,
        op_kwargs={}
    )
